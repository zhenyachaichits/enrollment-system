...
<div class="scroll">
                        ...
                        <div class="well bs-component">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-md-offset-6">
                                    <a onclick="$('.scroll').moveUp();" class="btn btn-primary scroll-button">Previous</a>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="well bs-component">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea name="privileges" class="form-control" rows="3" id="privileges"></textarea>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="well bs-component">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-md-offset-6">
                                    <a onclick="$('.scroll').moveUp();" class="btn btn-primary scroll-button">Previous</a>
                                    <button id="confirm" type="submit" class="btn btn-raised btn-primary">Confirm</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <span id="errorMessage" class="btn btn-material-deeppurple" data-toggle="snackbar"
          data-content="One or more records are incorrect" data-timeout="4000" data-snackbar-id="snackbar1454251274095"></span>
    <span id="emailErrorMessage" class="btn btn-material-deeppurple" data-toggle="snackbar"
          data-content="Account with such email already exist" data-timeout="4000" data-snackbar-id="snackbar1454251274096"></span>
