...
public class SubjectDaoTest {
    ...
    @Ignore
    @Test
    public void testGetSubjectsByFacultyId() throws DaoException {
        List<Subject> subjects = dao.getSubjectsByFacultyId(testSubject.getId());

        assertTrue(subjects.contains(testSubject));
    }

    @Test
    public void testGetSubjectById() throws DaoException {
        Subject subject = dao.getSubjectById(testSubject.getId());
    ...
    public void testDeleteById() throws DaoException {
        boolean result = dao.delete(testSubject.getId());
    ...
    public void testCheckUpdateAvailability() throws DaoException {
        boolean result = dao.checkUpdateAvailability(testSubject);
