...
public enum CommandName {
    ...
    UPDATE_PROFILE, UPDATE_STUDENT_DATA, UPDATE_USER, UPDATE_SUBJECT,
    CREATE_APPLICATION, CREATE_USER, CREATE_FACULTY, CREATE_SUBJECT,
    DELETE_APPLICATION, DELETE_PROFILE, DELETE_USER, DELETE_SUBJECT,
